...
public class LoginPageWeb extends BasePage<WebDriver> implements LoginElement {
	...
	public void createEmployee() throws Exception {
		...
		MobileUtility.type(employeeFirstName, nameOfEmployee+Keys.TAB+"Ladwal"+Keys.TAB+nameOfEmployee+"@vtnetzwelt.com"+Keys.TAB+"123 54687935", "employee details", driver);
		MobileUtility.clickElement(nextStepBtn, driver, "nextStepBtn");
		...
		if(getEmployeeName.getAttribute("innerHTML").contains(nameOfEmployee)) {
			...
			MyExtentListeners.test.pass(MarkupHelper.createLabel("Verify if employee is created || Employee created successfully", ExtentColor.GREEN));
			...
			MyExtentListeners.test.fail(MarkupHelper.createLabel("Verify if employee is created || Employee creation failed", ExtentColor.RED));
